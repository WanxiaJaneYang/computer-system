//this is to test if the program could handle different address and different length argument
...
set RAM[2048] 32766,  // out of range element
set RAM[2049] 12,  // Set Arr[0]
set RAM[2050] -32768,  // Set Arr[1]
set RAM[2051] 34;  // Set Arr[2]
set RAM[2052] 32764;  // Set Arr[3]
set RAM[2053] 32765;  // Set Arr[4]
set RAM[2054] 32767;  // out of range element
